...
public class XYChart extends AbstractChart
{
    ...
    private int pointColour,lineColour;         // Colour of point and line symbols to draw.
    private float pointSize, lineWidth;         // Size of point and line symbols to draw in pixel units.
    private ColourTable cTable;                 // Used to colour data points.
    ...
    {
        super(parent);
        pointColour   = graphics.color(120);
        lineColour    = graphics.color(120);
        pointSize     = 4;
        lineWidth     = 0;
        maxPointSize  = 0;
        cTable        = null;
